---
name: fec-refactoring-data
description: Use when behavior-preserving frontend refactoring focuses on variable meaning, field naming, derived state, or reference/value identity, and the selected technique needs family-specific mechanics, risks, and JavaScript/TypeScript/React/Vue adaptation.
---
...
## Procedure
1. Confirm the selected technique and its preconditions in [Data Refactorings](references/data-refactorings.md).
