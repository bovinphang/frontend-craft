...
description: Use when behavior-preserving frontend refactoring focuses on behavior/data ownership, statement placement, loops, or dead-code knowledge, and the selected technique needs family-specific mechanics, risks, and JavaScript/TypeScript/React/Vue adaptation.
---
...
## Procedure
1. Confirm the selected technique and its preconditions in [Moving Feature Refactorings](references/moving-refactorings.md).
