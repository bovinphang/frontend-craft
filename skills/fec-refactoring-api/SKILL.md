---
name: fec-refactoring-api
description: Use when behavior-preserving frontend refactoring focuses on function API shape, flags, dependencies, mutability, construction, or command/function trade-offs, and the selected technique needs family-specific mechanics, risks, and JavaScript/TypeScript/React/Vue adaptation.
---
...
## Procedure
1. Confirm the selected technique and its preconditions in [API Refactorings](references/api-refactorings.md).
