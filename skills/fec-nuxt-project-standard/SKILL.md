...
description: Use when creating or reviewing Nuxt 3 projects, pages, layouts, SSR/SSG behavior, composables, data fetching, route middleware, plugins, modules, or Vue 3 + TypeScript Nuxt conventions; Chinese triggers include Nuxt, Nuxt 3.
---
