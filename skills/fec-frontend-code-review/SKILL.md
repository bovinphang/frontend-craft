...
description: Use when the user asks for frontend code review, PR review, architecture and maintainability assessment, type-safety review, accessibility review, performance review, or testability feedback; Chinese triggers include 代码审查, 代码评审, review.
---
