...
description: Use when implementing or reviewing TanStack Query/React Query data fetching, server state, query keys, caching, invalidation, mutations, optimistic updates, infinite queries, or API-layer integration; Chinese triggers include 数据获取, 缓存, 乐观更新.
---
