...
description: Use when working in non-framework legacy frontend projects using vanilla JavaScript, jQuery, HTML/CSS, MPA pages, server-rendered templates, or long-lived legacy code that needs safer maintenance; Chinese triggers include 传统前端, 原生 JS, jQuery.
---
