...
3. 选择生成路线
   ...
   - 浏览器可打开的架构、流程、序列、数据流和生命周期图，先读 [html-technical-diagrams.md](references/html-technical-diagrams.md)，再用 [tech-diagram-render.mjs](scripts/tech-diagram-render.mjs) 渲染 JSON IR：
     ```bash
