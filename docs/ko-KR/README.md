...
<details>
<summary>전체 18개 템플릿 파일 보기</summary>

| 파일                          | 용도                                                      |
| ----------------------------- | --------------------------------------------------------- |
| `CLAUDE.md`                   | 프로젝트 설명, 명령어, 작업 원칙, 보안                    |
| `settings.json`               | 권한 화이트리스트/블랙리스트, 환경 변수                   |
| `rules/vue.md`                | Vue 3 컴포넌트 기준 및 안티패턴                           |
| `rules/react.md`              | React 컴포넌트 기준 및 안티패턴                           |
| `rules/design-system.md`      | 디자인 시스템, 토큰, 접근성                               |
| `rules/testing.md`            | 테스트 및 검증 규칙                                       |
| `rules/git-conventions.md`    | Conventional Commits                                      |
| `rules/i18n.md`               | 국제화 카피 기준                                          |
| `rules/performance.md`        | 프론트엔드 성능 최적화 규칙                               |
| `rules/api-layer.md`          | API 계층 타입화 및 오류 처리                              |
| `rules/state-management.md`   | 상태 분류, 전략, 안티패턴                                 |
| `rules/error-handling.md`     | 오류 계층화, Error Boundary, 폴백 UI, 보고                |
| `rules/naming-conventions.md` | 파일, 컴포넌트, 변수, 라우트, API, CSS 통일 명명          |
| `rules/code-comments.md`      | 프론트엔드 주석 작성 시점과 방법                          |
| `rules/ci-cd.md`              | CI/CD 파이프라인 단계, GitHub Actions / GitLab CI, 시크릿 |
| `rules/refactoring.md`        | 리팩토링 제약 및 기능 동등성 요구사항                     |
| `rules/agent-workflow.md`     | 에이전트 간 협업 경계 및 위임                             |
